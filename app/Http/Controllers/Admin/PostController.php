...
// $path = $filenameWithExt->storeAs($uploadPath, $fileNameToStore, ['disk' => 'public']);		//move file to new location
// $filePath = storage_path('app/public/'.$uploadPath.$fileNameToStore);
